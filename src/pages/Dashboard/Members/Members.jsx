...
const Members = () => {
  const memberStats = useMemo(
    () => [
      { label: "Total Members", bgClass: "bg-white", value: 50292938 },
      { label: "Students", bgClass: "bg-primary", value: 50292938 },
      { label: "Doctors", bgClass: "bg-secondary", value: 50292938 },
      { label: "Global Network", bgClass: "bg-tertiary", value: 50292938 },
    ],
    []
  );
